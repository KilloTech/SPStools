...
JOBS = [
    ...
    ("NOAA20 DAY",         "LEO", "NOAA-20 VIIRS giorno",        "E1B-VIIRS-1","30 14 * * *"),
    ("NOAA20 NIG",         "LEO", "NOAA-20 VIIRS notte",         "E1B-VIIRS-1","30 3 * * *"),
    ("SNPP DAY",           "LEO", "Suomi-NPP VIIRS giorno",      "E1B-VIIRS-2","15 14 * * *"),
    ("SNPP NIG",           "LEO", "Suomi-NPP VIIRS notte",       "E1B-VIIRS-2","15 3 * * *"),
