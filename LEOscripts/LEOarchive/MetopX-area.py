...
#***********************************************************************
#
# Satellite: Metop-X                                       Sensor: avhrr
...
# EUMETCast    : Metop-B files arrive as *.bz2 in channel E1B-EPS-10 (Basic Service)
# EUMETCast    : Metop-C files arrive as *.bz2 in channel E1B-EPS-10 (Basic Service)
...
if OS == 'Linux':
    segdir = ['/srv/E1B-EPS-10', '/srv/E1B-EPS-10']
    decomp = [False, False]
    isbulk = [False, False]
elif OS == 'Windows':
    segdir = ['Z:/E1B-EPS-10', 'Z:/E1B-EPS-10']
    decomp = [False, False]
    isbulk = [False, False]
else:
...
if NoD == 'DAY':
    composites = ['overview', 'natural_color', 'natural_enh', 'cloud_phase_distinction',]
else:   # 'NIG'
...
# area = 'africa2km'                # Try 2km resolution only if your PC has a minimum of 32 GB RAM
# area = 'samerica2km'              # Try 2km resolution only if your PC has a minimum of 32 GB RAM
# area = 'namerica2km'              # Try 2km resolution only if your PC has a minimum of 32 GB RAM
# area = 'africa5km'
# area = 'samerica5km'
# area = 'namerica5km'
area = 'eurol'
...
Yea, Mon, Day, Hou, Min, height = leo_images(Yea, Mon, Day, sat, NoD, True, segdir, decomp, isbulk, 'avhrr_l1b_eps',
