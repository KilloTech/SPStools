...
#-------------------------------------------------------------------------
#
# CH-3123 Belp, 2022/01/12        License GPL3          (c) Ernst Lobsiger
#
#*************************************************************************
#
...
if OS == 'Linux':
    segdir = ['/srv/E1B-RDS-1', '/srv/E1B-RDS-1']
    decomp = [False, False]
    isbulk = [False, False]
elif OS == 'Windows':
    segdir = ['Z:/E1B-RDS-1', 'Z:/E1B-RDS-1']
    decomp = [False, False]
    isbulk = [False, False]
else:
...
Yea, Mon, Day, Hou, Min, height = leo_images(Yea, Mon, Day, sat, NoD, True, segdir, decomp, isbulk, 'nwcsaf-pps_nc',
