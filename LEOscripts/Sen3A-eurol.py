#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# USAGE: Sen3A-eurol.py YYYYmmddNoD  (NoD = DAY only, OLCI is daylight only)
# Satellite Sentinel-3A - OLCI L1b ERR | Area: eurol
# Reader: olci_l1b | Segdir: /home/sps/received/hvs-2/E2H-S3A-02
