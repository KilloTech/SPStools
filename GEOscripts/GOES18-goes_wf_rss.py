...
# -----------------------------------------------------------------------
# EUMETSAT is EUMETCast disseminating 10 minutes GOES17 data in E1H-TPG-4
# GOES17 at 137.2 degrees West has noon at app. 21:00 UTC, sensor 'abi'
#
...
#************************************************************************
#
# Typical naming of GOES17 channel data files (channel C16 is shown below)
...
composites = ['airmass', 'colorized_ir_clouds', 'overview']

# Choose your area ('full_scan' was not pretty) GOES17 'full_scan' has been replaced by 'goes_wf_2km'
# area = 'southamerica'
# area = 'goes_wf_2km'
area = 'goes_wf_rss'
# area = 'n_america'
...
for composite in composites:
    ...
    magick = get_magick(Yea, Mon, Day, Hou, Min, height, logo1, logo2, service, channel,
                        ...
                        subdir='frames')  # basedir=basedir, subdir=subdir
