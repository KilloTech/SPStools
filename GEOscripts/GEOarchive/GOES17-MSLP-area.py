#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# USAGE: GOES17.py YYYYmmddHHMM, where dd=01..31, HH=00..23, MM=00,10,...
#************************************************************************
#
# American geostationary satellite GOES-17 at 137.2 degrees West (Hawaii)
# -----------------------------------------------------------------------
# EUMETSAT is EUMETCast disseminating 10 minutes GOES17 data in E1H-TPG-3
...
# Example name : OR_ABI-L1b-RadF-M6C16_G17_s20220972030321_e20220972039399_c20220972039451.nc
...
# EUMETCast    : These files arrive as above in channel E1H-TPG-3 (HVS-1)
