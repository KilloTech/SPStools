#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# USAGE: MSG3-msg_fes_3km.py YYYYmmddHHMM
# Satellite MSG3 - Full disk | Europe (eurol) - INGV/SPS adapted
# Reader: seviri_l1b_hrit | Segdir: /home/sps/received/bas/E1B-GEO-3
...
areas = ['msg_fes_3km', 'eurol']    # full disk + European detail
