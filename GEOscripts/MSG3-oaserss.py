#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# USAGE: MSG3.py YYYYmmddHHMM, where dd=01..31, HH=00..23, MM=00,05,10,..
#************************************************************************
#
# European geostationary satellite Meteosat-10 (MSG3) at 9.5 degrees East
#------------------------------------------------------------------------
# EUMETSAT is EUMETCast disseminating MSG3 data in Basic channel E1B-GEO-5
# Meteosat-10 (MSG3), at 9.5° noon at about 11:20 UTC, instrument 'seviri'
#
...
#
# MSG3 is EUMETSAT's RSS platform: coverage limited to northern hemisphere
#
# CH-3123 Belp, 2022/12/10       License GPL3          (c) Ernst Lobsiger
#
#************************************************************************
#
# Typical naming of MSG3 channel data files (channel WV_062 segment 6 below)
...
# Example name : H-000-MSG3__-MSG3_RSS____-WV_062___-000006___-202204070000-C__
# Hugo's ruler : 0123456789012345678901234567890123456789012345678901234567890
# copied EMCV  : 0         1         2         3         4         5         6
# EUMETCast    : These files arrive as above in channel E1B-GEO-5 (Basic)
...
composites = ['ir_overview', 'overview', 'natural_with_night_fog']

# Choose your area (HRV data has only limited coverage), 'seviri_0deg' has been renamed 'msg_fes_3km'
# area = 'msg_fes_3km'
# area = 'eurol'
# area = 'westminster'
# area = 'isleofman'
...
height = geo_images(Yea, Mon, Day, Hou, Min, sat, segdir, decomp, isbulk, 'seviri_l1b_hrit', composites,
                    ...
                    ADDpoints, ADDstation, GEOcache, OVRcache, testrun)  # basedir=basedir, subdir=subdir
...
for composite in composites:
    ...
    magick = get_magick(Yea, Mon, Day, Hou, Min, height, logo1, logo2, service, channel,
                        receiver, sat, instrument, composite, area, testrun, ADDlegend,
