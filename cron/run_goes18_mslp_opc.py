#!/usr/bin/env python3
# Wrapper cron per GOES18 MSLP OPC
# Cron: 15 4,10,16,22 * * *
...
logging.info(f"GOES18 MSLP OPC start slot={dat_str}")
r = subprocess.run(
    ["/home/sps/miniconda3/envs/pytroll/bin/python3",
     "/home/sps/SPStools/GEOscripts/GOES18-MSLP-opcpe.py",
     dat_str],
    capture_output=True, text=True,
    cwd="/home/sps/SPStools/GEOscripts"
)
logging.info(f"GOES18 MSLP OPC done slot={dat_str} rc={r.returncode}")
if r.returncode != 0:
    logging.error(f"GOES18 MSLP OPC stderr: {r.stderr[-500:]}")
